...
@Component({
  ...
  templateUrl: "./resumen-personal.component.html",
  styleUrl: "./inicio.component.scss",
  imports: [RouterLink, TripleStarComponent],
  standalone: true,
})
export class ResumenPersonalComponent implements OnInit, OnDestroy {
