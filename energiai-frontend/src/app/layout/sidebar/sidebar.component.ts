...
export class SidebarComponent {
  ...
  readonly items: ItemMenu[] = [
    ...
    },
    {
      ...
      colorIcono: "icono-analisis",
    },
    {
      etiqueta: "Historial",
      ruta: "/historial",
      icono: "pe-7s-notebook",
      colorIcono: "icono-historial",
    },
    {
      etiqueta: "Comparar Períodos",
      ruta: "/comparacion",
      icono: "pe-7s-graph2",
      colorIcono: "icono-comparacion",
    },
    {
      etiqueta: "Procesamiento CSV",
      ruta: "/procesamiento-csv",
      icono: "pe-7s-upload",
      colorIcono: "icono-csv",
    },
    {
      etiqueta: "Ranking Energético",
      ruta: "/ranking",
      icono: "pe-7s-cup",
      colorIcono: "icono-ranking",
    },
    {
      etiqueta: "Simulador de Ahorro",
      ruta: "/simulador",
      icono: "pe-7s-calculator",
      colorIcono: "icono-simulador",
    },
  ];
